...
import com.nti.module_moveinbound.databinding.MiongoingItemBinding;
...
public class OngoingAdapter extends RecyclerView.Adapter<OngoingAdapter.ViewHolder>{
    ...
    public OngoingAdapter(Context context, List<MoveinboundOrderInfo> orderInfos) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        MiongoingItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.miongoing_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        MiongoingItemBinding binding;

        public ViewHolder(MiongoingItemBinding binding) {
