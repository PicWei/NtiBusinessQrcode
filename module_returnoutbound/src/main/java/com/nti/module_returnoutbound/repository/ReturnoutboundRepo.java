...
import com.nti.module_returnoutbound.service.IReturnoutboundService;
...
public class ReturnoutboundRepo {
    public MutableLiveData<DataResult<List<ReturnoutboundOrderInfo>>> PDA_H(Paramer paramer){
        final MutableLiveData<DataResult<List<ReturnoutboundOrderInfo>>> data = new MutableLiveData<>();
        final List<ReturnoutboundOrderInfo> orderInfos = new ArrayList<>();
        HttpUtils.getInstance().with(IReturnoutboundService.class).PDA_H(paramer)
                ...
                .subscribe(new Observer<JsonObject>() {
                    ...
                    public void onNext(@NotNull JsonObject jsonObject) {
                        ...
                        try {
                            ...
                            DataResult<List<ReturnoutboundOrderInfo>> dataResult = new DataResult<>(0, orderInfos);
                    ...
                    public void onError(@NotNull Throwable e) {
                        DataResult<List<ReturnoutboundOrderInfo>> dataResult = new DataResult<>(-1, null);
                        data.setValue(dataResult);
                    }
    ...
    public MutableLiveData<JsonObject> updataSellListStatues(UpParamer paramer){
        ...
        HttpUtils.getInstance().with(IReturnoutboundService.class).updataSellListStatues(paramer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<JsonObject>() {
                    @Override
    ...
    public MutableLiveData<JsonObject> errorSignReceive(ErrorSignReceiveParamer paramer){
        final MutableLiveData<JsonObject> data = new MutableLiveData<>();
        HttpUtils.getInstance().with(IReturnoutboundService.class).errorSignReceive(paramer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<JsonObject>() {
                    @Override
