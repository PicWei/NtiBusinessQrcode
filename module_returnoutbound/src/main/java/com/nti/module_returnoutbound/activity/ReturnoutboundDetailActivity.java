...
@Route(path = ARouterPath.RETURNOUTBOUNDDETAIL_PATH)
public class ReturnoutboundDetailActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_returnoutbound_detail);
    ...
    protected void onStart() {
        ...
        adapter.setOnItemClickListener(new ReturnoutboundDetailAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(ReturnoutboundDetail detail) {
                String pcigcode = detail.getBD_PCIG_CODE();
                List<ReturnoutboundBarcode> barcodes = LitePal.where("pcigcode = ? and isSubmit = 0", pcigcode).find(ReturnoutboundBarcode.class);
                Collections.sort(barcodes, new Comparator<ReturnoutboundBarcode>() {
                    @Override
                    public int compare(ReturnoutboundBarcode salesBarcode, ReturnoutboundBarcode t1) {
                        return t1.getScantime().compareTo(salesBarcode.getScantime());
                    }
                });
                BasePopupView popupView = new BarcodeListPopup(ReturnoutboundDetailActivity.this);
                new XPopup.Builder(ReturnoutboundDetailActivity.this)
                                                ...
                                                public void onChanged(JsonObject jsonObject) {
                                                    if (jsonObject == null){
                                                        ...
                                                        if (code.equals("0")){
                                                            ...
                                                            Toast.makeText(ReturnoutboundDetailActivity.this, "更改状态失败", Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                }
                                            });
        ...
        ViewModel.errorSignReceive(esrparamer).observe(this, new Observer<JsonObject>() {
            ...
            public void onChanged(JsonObject jsonObject) {
                if (jsonObject == null){
                    ...
                    Toast.makeText(ReturnoutboundDetailActivity.this, "异常条码上传成功", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
