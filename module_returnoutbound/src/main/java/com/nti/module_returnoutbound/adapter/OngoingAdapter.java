...
import com.nti.module_returnoutbound.databinding.RoongoingItemBinding;
...
public class OngoingAdapter extends RecyclerView.Adapter<OngoingAdapter.ViewHolder>{
    ...
    public OngoingAdapter(Context context, List<ReturnoutboundOrderInfo> orderInfos) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        RoongoingItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.roongoing_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        RoongoingItemBinding binding;

        public ViewHolder(RoongoingItemBinding binding) {
