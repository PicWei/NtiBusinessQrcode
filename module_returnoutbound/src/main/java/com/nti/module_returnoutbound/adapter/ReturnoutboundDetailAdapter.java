...
import com.nti.module_returnoutbound.databinding.ReturnoutbounddetailItemBinding;
 ...
 * @describe
 */
public class ReturnoutboundDetailAdapter extends RecyclerView.Adapter<ReturnoutboundDetailAdapter.ViewHolder>{
    private List<ReturnoutboundDetail> details;
    private Context context;
    private LayoutInflater inflater;
    private OnItemClickListener onItemClickListener;

    public ReturnoutboundDetailAdapter(List<ReturnoutboundDetail> details, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ReturnoutbounddetailItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.returnoutbounddetail_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ReturnoutboundDetail detail = details.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ReturnoutbounddetailItemBinding binding;

        public ViewHolder(ReturnoutbounddetailItemBinding binding) {
    ...
    public interface OnItemClickListener{
        void onItemClick(ReturnoutboundDetail detail);
    }
}
