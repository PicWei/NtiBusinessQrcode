...
import com.nti.module_sortingoutbound.databinding.SoongoingItemBinding;
...
public class OngoingAdapter extends RecyclerView.Adapter<OngoingAdapter.ViewHolder>{
    ...
    public OngoingAdapter(Context context, List<SortingoutboundOrderInfo> orderInfos) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        SoongoingItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.soongoing_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        SoongoingItemBinding binding;

        public ViewHolder(SoongoingItemBinding binding) {
