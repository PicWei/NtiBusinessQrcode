...
import com.nti.module_sortingoutbound.service.ISortingoutboundService;
...
public class SortingoutboundRepo {
    public MutableLiveData<DataResult<List<SortingoutboundOrderInfo>>> PDA_H(Paramer paramer){
        final MutableLiveData<DataResult<List<SortingoutboundOrderInfo>>> data = new MutableLiveData<>();
        final List<SortingoutboundOrderInfo> orderInfos = new ArrayList<>();
        HttpUtils.getInstance().with(ISortingoutboundService.class).PDA_H(paramer)
                ...
                .subscribe(new Observer<JsonObject>() {
                    ...
                    public void onNext(@NotNull JsonObject jsonObject) {
                        ...
                        try {
                            ...
                            DataResult<List<SortingoutboundOrderInfo>> dataResult = new DataResult<>(0, orderInfos);
                    ...
                    public void onError(@NotNull Throwable e) {
                        DataResult<List<SortingoutboundOrderInfo>> dataResult = new DataResult<>(-1, null);
                        data.setValue(dataResult);
                    }
    ...
    public MutableLiveData<JsonObject> updataSellListStatues(UpParamer paramer){
        ...
        HttpUtils.getInstance().with(ISortingoutboundService.class).updataSellListStatues(paramer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<JsonObject>() {
                    @Override
    ...
    public MutableLiveData<JsonObject> errorSignReceive(ErrorSignReceiveParamer paramer){
        final MutableLiveData<JsonObject> data = new MutableLiveData<>();
        HttpUtils.getInstance().with(ISortingoutboundService.class).errorSignReceive(paramer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<JsonObject>() {
                    @Override
