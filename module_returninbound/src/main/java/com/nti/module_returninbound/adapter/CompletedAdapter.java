...
import com.nti.module_returninbound.databinding.RicompletedItemBinding;
...
public class CompletedAdapter extends RecyclerView.Adapter<CompletedAdapter.ViewHolder>{
    ...
    public CompletedAdapter(Context context, List<ReturninboundOrderInfo> orderInfos) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        RicompletedItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.ricompleted_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        RicompletedItemBinding binding;

        public ViewHolder(RicompletedItemBinding binding) {
    ...
    public interface onCheckListener{
        void onCheckChange(List<ReturninboundOrderInfo> orderInfos);
    }
}
