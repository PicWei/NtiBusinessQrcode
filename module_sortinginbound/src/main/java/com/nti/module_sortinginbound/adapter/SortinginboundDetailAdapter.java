...
import com.nti.module_sortinginbound.databinding.SortinginbounddetailItemBinding;
 ...
 * @describe
 */
public class SortinginboundDetailAdapter extends RecyclerView.Adapter<SortinginboundDetailAdapter.ViewHolder>{

    private List<SortinginboundDetail> details;
    private Context context;
    private LayoutInflater inflater;
    private OnItemClickListener onItemClickListener;

    public SortinginboundDetailAdapter(List<SortinginboundDetail> details, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        SortinginbounddetailItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.sortinginbounddetail_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        SortinginboundDetail detail = details.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        SortinginbounddetailItemBinding binding;

        public ViewHolder(SortinginbounddetailItemBinding binding) {
    ...
    public interface OnItemClickListener{
        void onItemClick(SortinginboundDetail detail);
    }
