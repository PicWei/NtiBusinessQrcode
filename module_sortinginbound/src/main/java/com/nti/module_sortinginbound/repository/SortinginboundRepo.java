...
import com.nti.module_sortinginbound.service.ISortinginboundService;
...
public class SortinginboundRepo {
    public MutableLiveData<DataResult<List<SortinginboundOrderInfo>>> PDA_H(Paramer paramer){
        final MutableLiveData<DataResult<List<SortinginboundOrderInfo>>> data = new MutableLiveData<>();
        final List<SortinginboundOrderInfo> orderInfos = new ArrayList<>();
        HttpUtils.getInstance().with(ISortinginboundService.class).PDA_H(paramer)
                ...
                .subscribe(new Observer<JsonObject>() {
                    ...
                    public void onNext(@NotNull JsonObject jsonObject) {
                        ...
                        try {
                            ...
                            DataResult<List<SortinginboundOrderInfo>> dataResult = new DataResult<>(0, orderInfos);
                    ...
                    public void onError(@NotNull Throwable e) {
                        DataResult<List<SortinginboundOrderInfo>> dataResult = new DataResult<>(-1, null);
                        data.setValue(dataResult);
                    }
    ...
    public MutableLiveData<JsonObject> updataSellListStatues(UpParamer paramer){
        ...
        HttpUtils.getInstance().with(ISortinginboundService.class).updataSellListStatues(paramer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<JsonObject>() {
                    @Override
    ...
    public MutableLiveData<JsonObject> errorSignReceive(ErrorSignReceiveParamer paramer){
        final MutableLiveData<JsonObject> data = new MutableLiveData<>();
        HttpUtils.getInstance().with(ISortinginboundService.class).errorSignReceive(paramer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<JsonObject>() {
                    @Override
