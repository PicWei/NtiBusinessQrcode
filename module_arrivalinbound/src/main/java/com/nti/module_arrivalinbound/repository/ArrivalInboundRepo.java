...
import com.nti.module_arrivalinbound.service.IArrivalinService;
...
public class ArrivalInboundRepo {
    public MutableLiveData<DataResult<List<ArrivalInboundOrderInfo>>> PDA_H(Paramer paramer){
        final MutableLiveData<DataResult<List<ArrivalInboundOrderInfo>>> data = new MutableLiveData<>();
        final List<ArrivalInboundOrderInfo> orderInfos = new ArrayList<>();
        HttpUtils.getInstance().with(IArrivalinService.class).PDA_H(paramer)
                ...
                .subscribe(new Observer<JsonObject>() {
                    ...
                    public void onNext(@NotNull JsonObject jsonObject) {
                        ...
                        try {
                            ...
                            DataResult<List<ArrivalInboundOrderInfo>> dataResult = new DataResult<>(0, orderInfos);
                    ...
                    public void onError(@NotNull Throwable e) {
                        DataResult<List<ArrivalInboundOrderInfo>> dataResult = new DataResult<>(-1, null);
                        data.setValue(dataResult);
                    }
    ...
    public MutableLiveData<JsonObject> updataSellListStatues(UpParamer paramer){
        ...
        HttpUtils.getInstance().with(IArrivalinService.class).updataSellListStatues(paramer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<JsonObject>() {
                    @Override
    ...
    public MutableLiveData<JsonObject> errorSignReceive(ErrorSignReceiveParamer paramer){
        final MutableLiveData<JsonObject> data = new MutableLiveData<>();
        HttpUtils.getInstance().with(IArrivalinService.class).errorSignReceive(paramer)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<JsonObject>() {
                    @Override
