 ...
 * @describe
 */
public class MoveoutboundBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public MoveoutboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
