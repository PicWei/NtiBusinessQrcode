 ...
 * @describe
 */
public class AdjustinboundBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public AdjustinboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
