 ...
 * @describe
 */
public class SortingoutboundBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public SortingoutboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
