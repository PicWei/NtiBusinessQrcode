 ...
 * @describe
 */
public class SortinginboundOrderInfo extends LitePalSupport {
    //单据uuid
    ...
    public SortinginboundOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
    ...
    public String toString() {
        return "SortinginboundOrderInfo{" +
                "BB_UUID='" + BB_UUID + '\'' +
