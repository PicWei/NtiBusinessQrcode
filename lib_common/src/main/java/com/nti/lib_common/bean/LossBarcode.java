 ...
 * @describe
 */
public class LossBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public LossBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
