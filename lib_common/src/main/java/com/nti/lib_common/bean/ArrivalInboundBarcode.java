 ...
 * @describe
 */
public class ArrivalInboundBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public ArrivalInboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
