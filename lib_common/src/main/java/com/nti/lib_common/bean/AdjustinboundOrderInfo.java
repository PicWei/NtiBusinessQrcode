 ...
 * @describe
 */
public class AdjustinboundOrderInfo extends LitePalSupport {
    ...
    public AdjustinboundOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
