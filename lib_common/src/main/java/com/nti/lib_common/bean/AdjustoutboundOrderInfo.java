 ...
 * @describe
 */
public class AdjustoutboundOrderInfo extends LitePalSupport {
    //单据uuid
    ...
    public AdjustoutboundOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
    ...
    public String toString() {
        return "AdjustoutboundOrderInfo{" +
                "BB_UUID='" + BB_UUID + '\'' +
