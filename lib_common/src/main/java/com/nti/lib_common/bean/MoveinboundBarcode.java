 ...
 * @describe
 */
public class MoveinboundBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public MoveinboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
