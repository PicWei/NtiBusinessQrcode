 ...
 * @describe
 */
public class MoveinboundOrderInfo extends LitePalSupport {
    //单据uuid
    ...
    public MoveinboundOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
