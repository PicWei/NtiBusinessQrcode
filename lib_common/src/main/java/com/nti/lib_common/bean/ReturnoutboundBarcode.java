 ...
 * @describe
 */
public class ReturnoutboundBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public ReturnoutboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
