 ...
 * @describe
 */
public class SortinginboundBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public SortinginboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
