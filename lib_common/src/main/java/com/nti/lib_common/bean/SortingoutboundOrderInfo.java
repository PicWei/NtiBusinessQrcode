 ...
 * @describe
 */
public class SortingoutboundOrderInfo extends LitePalSupport {
    //单据uuid
    ...
    public SortingoutboundOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
    ...
    public String toString() {
        return "SortingoutboundOrderInfo{" +
                "BB_UUID='" + BB_UUID + '\'' +
