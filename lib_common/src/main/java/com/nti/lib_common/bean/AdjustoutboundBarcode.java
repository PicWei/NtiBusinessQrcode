 ...
 * @describe
 */
public class AdjustoutboundBarcode extends LitePalSupport implements Serializable {
    private String UUID;
    ...
    public AdjustoutboundBarcode(String UUID, String pcigcode, String pcigname, String barcode, String scantime, String scancode) {
        this.UUID = UUID;
