 ...
 * @describe
 */
public class ReturnoutboundOrderInfo extends LitePalSupport {
    //单据uuid
    ...
    public ReturnoutboundOrderInfo(String BB_UUID, String BB_CONTRACT_NO, String BB_BT_CODE, String BB_TICKET_NO,
    ...
    public String toString() {
        return "ReturnoutboundOrderInfo{" +
                "BB_UUID='" + BB_UUID + '\'' +
