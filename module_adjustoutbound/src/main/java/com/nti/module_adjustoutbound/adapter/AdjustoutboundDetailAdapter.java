...
import com.nti.module_adjustoutbound.databinding.AdjustoutbounddetailItemBinding;
 ...
 * @describe
 */
public class AdjustoutboundDetailAdapter extends RecyclerView.Adapter<AdjustoutboundDetailAdapter.ViewHolder>{

    private List<AdjustoutboundDetail> details;
    private Context context;
    private LayoutInflater inflater;
    private OnItemClickListener onItemClickListener;

    public AdjustoutboundDetailAdapter(List<AdjustoutboundDetail> details, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        AdjustoutbounddetailItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.adjustoutbounddetail_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        AdjustoutboundDetail detail = details.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        AdjustoutbounddetailItemBinding binding;

        public ViewHolder(AdjustoutbounddetailItemBinding binding) {
    ...
    public interface OnItemClickListener{
        void onItemClick(AdjustoutboundDetail detail);
    }
