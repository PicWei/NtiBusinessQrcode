...
import com.nti.module_adjustoutbound.databinding.AocompletedItemBinding;
...
public class CompletedAdapter extends RecyclerView.Adapter<CompletedAdapter.ViewHolder>{
    ...
    public CompletedAdapter(Context context, List<AdjustoutboundOrderInfo> orderInfos) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        AocompletedItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.aocompleted_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        AocompletedItemBinding binding;

        public ViewHolder(AocompletedItemBinding binding) {
    ...
    public interface onCheckListener{
        void onCheckChange(List<AdjustoutboundOrderInfo> orderInfos);
    }
}
