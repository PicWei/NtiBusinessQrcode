...
import com.nti.module_adjustinbound.databinding.AicompletedItemBinding;
...
public class CompletedAdapter extends RecyclerView.Adapter<CompletedAdapter.ViewHolder>{
    ...
    public CompletedAdapter(Context context, List<AdjustinboundOrderInfo> orderInfos) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        AicompletedItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.aicompleted_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        AicompletedItemBinding binding;

        public ViewHolder(AicompletedItemBinding binding) {
    ...
    public interface onCheckListener{
        void onCheckChange(List<AdjustinboundOrderInfo> orderInfos);
    }
}
